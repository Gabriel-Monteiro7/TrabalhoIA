...
# quantidade = 8
# Agente(quantidade,BuscaCustoUniforme,{},Rainha(quantidade),None,Rainha)

# quantidade = 3
# Agente(quantidade,BuscaProfundidade,7,None,Oitopeca(quantidade,[[1,4,2],[3,"",5],[6,7,8]]),Oitopeca)
