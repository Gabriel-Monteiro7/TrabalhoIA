...
def main():
	...
	"""Sem heuristica:"""
	#largura
	problema = t.Problema(teste1, operadores, teste_meta, funcao_custo)
	#profundiade
	problema1 = t.Problema(teste1, operadores, teste_meta, funcao_custo)
	#gulosa
	problema2 = t.Problema(teste1, operadores, teste_meta, heuristica_desordenado)
	#A* desordenado
	problema3 = t.Problema(teste1, operadores, teste_meta, heuristica_desordenado)
	#A* Manhattan
	problema4 = t.Problema(teste1, operadores, teste_meta, heuristica_manhattan)

	ini = time.time()
	resultado = t.busca(problema, enfileira_fifo)
	fim = time.time()
	ini1 = time.time()
	resultado1 = t.busca(problema1, enfileira_lifo)
	fim1 = time.time()
	ini2 = time.time()
	resultado2 = t.buscagulosa(problema2, enfileira_lifo)
	fim2 = time.time()
	ini3 = time.time()
	resultado3 = t.buscaaestrela(problema3, enfileira_lifo)
	fim3 = time.time()
	ini4 = time.time()
	resultado4 = t.buscaaestrela(problema4, enfileira_lifo)
	fim4 = time.time()
